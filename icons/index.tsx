...
export function WaterDrop({ className, size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function WaterGlass({ className, size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      className={className}
    >
      <path d="M18 2H6l1.5 18.5A2 2 0 0 0 9.5 22h5a2 2 0 0 0 2-2.18L18 2z" />
      <path d="M6 2h12" />
      <path d="M7 7h10" />
      <path d="M7 12h10" />
    </svg>
...
export function FireIcon({ className, size = 24 }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M12 2s-2 4-2 7c0 2.5 1.5 4 4 4s4-1.5 4-4c0-3-2-7-2-7z" />
      <path d="M8 14c-2 1-3 3-3 5 0 3.5 3.5 5 7 5s7-1.5 7-5c0-2-1-4-3-5" />
    </svg>
  );
}
...
export function Droplets({ className, size = 24 }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M7 16.3c-.9-1.2-1.5-2.6-1.5-4.3 0-3.9 3.5-7 5.5-9 2 2 5.5 5.1 5.5 9 0 1.7-.6 3.1-1.5 4.3" />
      <path d="M11 20c-.5-1-1.5-1.8-2.5-2.5" />
    </svg>
  );
}
